...
enum ResponseCodes { RC_OK, RC_EMPTY_STRING, RC_EMPTY_VECTOR, RC_BAD_INDEX, RC_BAD_SIZE, RC_BAD_INPUT, RC_NOT_FOUND, RC_NO_OBSERVERS, RC_ALREADY_BUSY, RC_ALREADY_HIRED, RC_SIZE };
