...
class Item: public LevelableObject {
  public:
    ...
    virtual ~Item() {}
    size_t get_owner_id() const { return _owner_id; }
    size_t get_rarity() const { return _rarity; }
    size_t get_kind() const { return _kind; }
    ...
    size_t get_slots(std::vector<bool>& result) const;
    size_t get_slots(const size_t& index, bool& result) const;
